...
var canvas = document.getElementById("road-game"); //Getting the canvas from DOM
...
var roads =
	[
		...
		new Road("roadimg.jpg", canvas.width)
	]; //Backgrounds

var player = new Car("car_blue.png", canvas.width / 2, canvas.height / 2, true); //Player's object
...
function Update() {
	...
	{
		objects.push(new Car("car.png", RandomInteger(30, canvas.width - 50), RandomInteger(250, 400) * -1, false));
	}
